export const features = [
  {
    ...
    title: "Effortless sports booking management",
    text: "With our sports booking system, manual scheduling and organization are a thing of the past. Our automated processes ensure you can focus on what matters—enjoying the game. It’s like having a personal assistant, minus the extra cost.",
    button: {
  ...
  },
  {
    ...
    caption: "Ultra-fast booking engine",
    title: "Blazing fast reservations",
    text: "Book your court in seconds with our high-speed, cloud-based booking engine. No more waiting—whether it’s a last-minute game or a well-planned tournament, your court is ready when you are.",
    button: {
